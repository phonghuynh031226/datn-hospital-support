  ...
  <div class="bg-gray-50 min-h-[calc(100vh-140px)] pb-16">
    ...
    <div class="max-w-6xl mx-auto px-4 mt-8">
      ...
      <div v-else class="bg-white p-6 md:p-8 rounded-3xl border border-gray-100 shadow-sm animate-fade-in space-y-8">
        ...
        <div class="space-y-4">
          <!-- Floor 2 -->
          <div class="flex flex-col md:flex-row items-stretch border border-indigo-100 rounded-2xl overflow-hidden hover:shadow-md transition-all">
            <div class="w-full md:w-32 bg-indigo-50/50 text-indigo-700 border-r border-indigo-100 flex flex-col justify-center items-center p-4 text-center">
              <span class="text-xs font-bold uppercase tracking-wider">Tầng 2</span>
              <span class="text-3xl font-black mt-1">LẦU 2</span>
            </div>
            <div class="flex-1 p-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <div class="bg-indigo-50/30 p-3 rounded-xl border border-indigo-50 flex items-center gap-3">
                <span class="text-xl">🏢</span>
                <div>
                  <h4 class="text-sm font-bold text-gray-800">Ban Giám Đốc</h4>
                  <p class="text-xs text-gray-400">Phòng điều hành tổng</p>
                </div>
              </div>
              <div class="bg-indigo-50/30 p-3 rounded-xl border border-indigo-50 flex items-center gap-3">
                <span class="text-xl">🩺</span>
                <div>
                  <h4 class="text-sm font-bold text-gray-800">Khoa Nhi</h4>
                  <p class="text-xs text-gray-400">Phòng khám nhi khoa 201-203</p>
                </div>
              </div>
              <div class="bg-indigo-50/30 p-3 rounded-xl border border-indigo-50 flex items-center gap-3">
                <span class="text-xl">🩺</span>
                <div>
                  <h4 class="text-sm font-bold text-gray-800">Khoa Mắt</h4>
                  <p class="text-xs text-gray-400">Phòng đo thị lực & Khám 205</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Floor 1 -->
          <div class="flex flex-col md:flex-row items-stretch border border-emerald-100 rounded-2xl overflow-hidden hover:shadow-md transition-all">
            <div class="w-full md:w-32 bg-emerald-50/50 text-emerald-700 border-r border-emerald-100 flex flex-col justify-center items-center p-4 text-center">
              <span class="text-xs font-bold uppercase tracking-wider">Tầng 1</span>
              <span class="text-3xl font-black mt-1">LẦU 1</span>
            </div>
            <div class="flex-1 p-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <div class="bg-emerald-50/30 p-3 rounded-xl border border-emerald-50 flex items-center gap-3">
                <span class="text-xl">🔬</span>
                <div>
                  <h4 class="text-sm font-bold text-gray-800">Cận Lâm Sàng</h4>
                  <p class="text-xs text-gray-400">X-Quang, Siêu Âm, Xét Nghiệm</p>
                </div>
              </div>
              <div class="bg-emerald-50/30 p-3 rounded-xl border border-emerald-50 flex items-center gap-3">
                <span class="text-xl">🩺</span>
                <div>
                  <h4 class="text-sm font-bold text-gray-800">Khoa Tim Mạch</h4>
                  <p class="text-xs text-gray-400">Khám tim mạch & Đo điện tim 101</p>
                </div>
              </div>
              <div class="bg-emerald-50/30 p-3 rounded-xl border border-emerald-50 flex items-center gap-3">
                <span class="text-xl">🩺</span>
                <div>
                  <h4 class="text-sm font-bold text-gray-800">Khoa Sản Phụ</h4>
                  <p class="text-xs text-gray-400">Khám thai & Siêu âm sản khoa 103</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Ground Floor -->
          <div class="flex flex-col md:flex-row items-stretch border border-amber-100 rounded-2xl overflow-hidden hover:shadow-md transition-all">
            <div class="w-full md:w-32 bg-amber-50/50 text-amber-700 border-r border-amber-100 flex flex-col justify-center items-center p-4 text-center">
              <span class="text-xs font-bold uppercase tracking-wider">Tầng Trệt</span>
              <span class="text-3xl font-black mt-1">TRỆT</span>
            </div>
            <div class="flex-1 p-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <div class="bg-amber-50/30 p-3 rounded-xl border border-amber-50 flex items-center gap-3">
                <span class="text-xl">🛎️</span>
                <div>
                  <h4 class="text-sm font-bold text-gray-800">Quầy Tiếp Đón</h4>
                  <p class="text-xs text-gray-400">Nơi làm thủ tục, Điều dưỡng trực</p>
                </div>
              </div>
              <div class="bg-amber-50/30 p-3 rounded-xl border border-amber-50 flex items-center gap-3">
                <span class="text-xl">💊</span>
                <div>
                  <h4 class="text-sm font-bold text-gray-800">Nhà Thuốc Bệnh Viện</h4>
                  <p class="text-xs text-gray-400">Cấp phát & Thanh toán thuốc lẻ</p>
                </div>
              </div>
              <div class="bg-amber-50/30 p-3 rounded-xl border border-amber-50 flex items-center gap-3">
                <span class="text-xl">🩺</span>
                <div>
                  <h4 class="text-sm font-bold text-gray-800">Nội - Ngoại Tổng Quát</h4>
                  <p class="text-xs text-gray-400">Phòng khám đa khoa số 1-4</p>
                </div>
              </div>
            </div>
          </div>
